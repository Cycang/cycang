...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buy = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VueResource = __webpack_require__(9); // <template>
	...
	exports.default = {
	   ...
	   ready: function ready() {
	      ...
	      var that = this;
	      this.$http.get('./mock/detail1.json').then(function (res) {
	                  ...
	                  if (imgs[i].complete) {
	                     ...
	                     if (iscomplete == imgs.length) {
	                        ...
	                        myScroll.on('scroll', function () {
	                           ...
	                           if (maxY >= 60) {
	                              that.more = true;
	                              that.$http.get('./mock/detail-more1.json').then(function (res) {
	   ...
	   methods: {
	      ...
	      loadMore: function loadMore() {
	         ...
	         this.more = true;
	         this.$http.get('./mock/detail-more1.json').then(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vuexMin = __webpack_require__(19);
