...
=======
	...
	var _classifySkirt = __webpack_require__(41);
	
	var _classifySkirt2 = _interopRequireDefault(_classifySkirt);
	
	var _classifyJacket = __webpack_require__(44);
>>>>>>> 193bcb6359f3ee9e787d90ff144a30efc47f1f81
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	   ...
	   ready: function ready() {
	      ...
	      var that = this;
	      this.$http.get('/mock/detail2.json').then(function (res) {
	                  ...
	                  if (imgs[i].complete) {
	                     ...
	                     if (iscomplete == imgs.length) {
	                        ...
	                        myScroll.on('scroll', function () {
	                           ...
	                           if (maxY >= 60) {
	                              that.more = true;
	                              that.$http.get('/mock/detail-more2.json').then(function (res) {
